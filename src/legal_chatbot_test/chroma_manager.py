...
from legal_chatbot_test.file_utils import load_documents_from_file
    ...
    for file_path in data_dir.glob("*"):
        if file_path.is_file():
            ...
            for doc in docs:
                ...
                # If source exists and hash differs 
            ...
            for chunk in updated_chunks:
                ...
                # If source still exists in DB and hash matches, chunk already exists 
